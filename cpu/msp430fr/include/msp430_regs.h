/*
 * Copyright (C) 2017 Daniel Friesel
 *
 ...
 *
 * @file
 * @brief       Cortex CMSIS style definition of MSP430FR registers
 *
 * @todo        This file is incomplete, not all registers are listed.
 *
 * @author      Daniel Friesel <daniel.friesel@tu-dortmund.de>
 */
 ...
 */
typedef struct {
    REG16   IE1;            /**< interrupt enable */
    REG16   IFG1;           /**< interrupt flag */
    REG16   RPCR;           /**< reset pin control */
} msp_sfr_t;

/* Note: P1&P2 as well as P3&P4 are interleaved with shared base addresses. */

/**
 * @brief   Digital I/O Port with interrupt functionality (P1-4)
 */
typedef struct {
    REG8    IN;         /**< input data */
    REG8    : 8;
    ...
    REG8    : 8;
    REG8    REN;        /**< pullup/pulldown enable */
    REG8    : 8;
    REG8    : 8;
    REG8    : 8;
    REG8    SEL0;       /**< alternative function select 0 */
    REG8    : 8;
    REG8    SEL1;       /**< alternative function select 1 */
    REG8    : 8;
    REG8    : 8;
    REG8    : 8;
    REG8    : 8;
    ...
    REG8    : 8;
    REG8    : 8;
    REG8    SELC;         /**< alternative function complement select */
    REG8    : 8;
...
/**
 * @brief   Digital I/O Port w/o interrupt functionality (PJ)
 */
typedef struct {
    REG8    IN;         /**< input data */
    REG8    : 8;
...
//#define CLK_BASE                ((uint16_t)0x0160)
/** @} */
